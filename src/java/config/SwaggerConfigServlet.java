...
public class SwaggerConfigServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp)
        ...
        try (PrintWriter out = resp.getWriter()) {
            ...
            // Admin change password for Staff/Manager
            out.println("    \"/api/secure/admin/users/change-password\": { \"post\": { \"tags\": [\"Admin\"], \"summary\": \"Đổi mật khẩu cho Staff/Manager\", \"description\": \"Chỉ Admin được đổi mật khẩu cho người dùng có role Staff hoặc Manager\", \"security\": [{ \"bearerAuth\": [] }], \"requestBody\": { \"required\": true, \"content\": { \"application/json\": { \"schema\": { \"type\": \"object\", \"properties\": { \"userId\": { \"type\": \"integer\" }, \"newPassword\": { \"type\": \"string\", \"minLength\": 6 } }, \"required\": [\"userId\", \"newPassword\"] } } } }, \"responses\": { \"200\": { \"description\": \"Đổi mật khẩu thành công\" }, \"400\": { \"description\": \"Sai dữ liệu hoặc không đúng role Staff/Manager\" }, \"401\": { \"description\": \"Chưa xác thực\" }, \"403\": { \"description\": \"Không có quyền\" }, \"500\": { \"description\": \"Lỗi server\" } } } }");

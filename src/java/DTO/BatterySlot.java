...
public class BatterySlot {
    ...
    private String chargingSlotType;
    ...
    public String getChargingSlotType() {
        return chargingSlotType;
    }

    public void setChargingSlotType(String chargingSlotType) {
        this.chargingSlotType = chargingSlotType;
    }

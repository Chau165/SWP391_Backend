...
public class UpdateProfileController extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            // basic unsafe-scheme check
            if (avatarUrl != null) {
                String t = avatarUrl.trim().toLowerCase();
                if (t.startsWith("javascript:") || t.startsWith("file:")) {
                    sendErrorResponse(response, 400, "Invalid avatar URL scheme");
                    return;
                }
            }
